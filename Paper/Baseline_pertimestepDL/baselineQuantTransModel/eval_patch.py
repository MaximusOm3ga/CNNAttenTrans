...
PROJECT_ROOT = os.path.abspath(os.path.join(PAPER_DIR, ".."))
if PROJECT_ROOT not in sys.path:
    sys.path.insert(0, PROJECT_ROOT)

from Paper.baseline_utils import make_forecast_pairs, reduce_to_patches, make_patch_forecast_pairs
...
def main():
    ...
    print("QuantFormer RAW-X baseline (patch-level comparable eval)")
    print(
